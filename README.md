...
### 🛠️ Tools & Technologies
 <img height="200" width="900" src="https://skillicons.dev/icons?i=androidstudio,apple,bash,bootstrap,docker,express,figma,git,github,githubactions,gitlab,html,java,js,jquery,linkedin,linux,mongodb,mysql,nextjs,nodejs,powershell,py,pytorch,react,redux,stackoverflow,svg,tailwind,tensorflow,ts,vercel,vite,vscode,wordpress&perline=10" />
